...
TOOLS: tuple[ToolDefinition, ...] = (
    ...
    ToolDefinition(
        ...
        category="strategy",
        label_zh="生成指标IDE策略",
        label_en="Generate Indicator IDE strategy",
        description_zh="根据用户确认的需求生成 QuantDinger 指标 IDE 策略代码。",
        description_en="Generate QuantDinger Indicator IDE strategy code after requirements are confirmed.",
        route="/indicator-ide",
